...
本文于 2018-12-13 以卡片形式更新，首发徐嘉乐作品集知识星球，2019-02-23 更新完毕集合成文。
...
而 Alfred 就是搜索功能的强力增强工具，除了可快速搜索，还可以快速定位文件，这个功能特别好用，特别是要发送文件给别人的时候，比那种通过目录查找的方式快不知道多少倍。
 ...
 优秀的系统或工具大多是「搜索重于目录分类」，例如 Alfred、Mac、Workflowy 等等，所以我在《徐嘉乐作品集》的「卡片写作八原则」篇就给出两个很重要卡片写作的建议：1）生产胜于管理；2）搜索胜于分类。
...
某日下午，桌面微信收到好友验证，顺手通过之后，对方发来信息：你好，请问可以简单介绍一下徐嘉乐作品集课程吗？

我随即敲下「;jj」，聊天窗口便出现这么一段：

「你好，感谢你关注徐嘉乐作品集，这个课程简介可能会帮到你：http://t.cn/R1Ompu7  如果在这里没有找到你想要的答案，可直接提问。」
...
常用语句：「;gw」：徐嘉乐作品集官网： http://www.learnwritingthehardway.cn/
